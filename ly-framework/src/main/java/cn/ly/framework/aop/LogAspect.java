...
public class LogAspect {
    ...
    //注解定义切点，输出日志导致aop出错，具体可看-->https://blog.csdn.net/lvoelife/article/details/126461571
    /*
    @Pointcut("@annotation(cn.ly.framework.annotation.SystemLog)")
    public void pointCut(){}
    */

    // @Around("pointCut()")改用注解
    @Around("within(cn.ly.*.controller..*)&&@annotation(systemLog)")
