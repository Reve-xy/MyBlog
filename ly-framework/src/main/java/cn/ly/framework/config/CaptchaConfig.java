...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBean(){
        ...
        //验证码字符的集合
        properties.setProperty("kaptcha.textproducer.char.string",config.getCharCaptchaSize());
        // 验证码文本字符长度 默认为5
    ...
    public DefaultKaptcha getKaptchaBeanMath(){
        ...
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "cn.ly.framework.config.KaptchaMathTextCreator");
        // 验证码文本字符间距 默认为2
