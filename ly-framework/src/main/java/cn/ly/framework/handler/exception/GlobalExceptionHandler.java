package cn.ly.framework.handler.exception;
...
public class GlobalExceptionHandler {
    ...
    public Result mismatchErrorHandler(MethodArgumentTypeMismatchException e,HttpServletRequest request) {
        String errmsg = "参数转换失败，方法："+ Objects.requireNonNull(e.getParameter().getMethod()).getName()+"，请求地址："+request.getRequestURL()+"，请求方式："+request.getMethod()
