  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" label-width="90px">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item>
            <el-button type="primary" size="medium" @click="handleSubmit" :disabled="disabled">{{ aId?"更新":"发布" }}</el-button>
          </el-form-item>
          <el-form-item>
            <el-button v-if="!aId" type="info" @click="handleSave" :disabled="disabled">保存到草稿箱</el-button>
          </el-form-item>
  ...
  methods: {
    ...
    handleSave() {
      ...
      addArticle(this.form).then(response => {
        ...
        this.disabled=true
        this.$store.dispatch('tabs/delCacheViews','Article')
