<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章数" align="center" prop="articleCount" />
...
import { changeCategoryStatus } from '@/api/content/category'
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      changeCategoryStatus(row.id, row.status)
    ...
    /* 管理当前分类下的文章*/
    handleManage(row) {
      this.$router.push('/content/article?category=' + row.id)
    },
    /** 导出按钮操作 */
    handleExport() {
