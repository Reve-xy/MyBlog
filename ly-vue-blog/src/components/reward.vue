...
<template>
  <div class="tRewardBox tcommonBox">
    <header>
      <h1>
        <a href="static/img/reward.jpg" target="_blank" class="toPath"> 赞赏 </a>
      </h1>
    </header>
    <section>
      <div>
      ...
      <h1>赞赏说明：</h1>
      <p>
        如果我的内容对你有帮助，你可以选择请作者喝杯咖啡☕️以示鼓励。<br>
        注：请备注留下你的姓名/昵称方便我公布赞赏记录。
      </p>
      <hr />
      <h1>赞赏方式：</h1>
      <el-row :gutter="30">
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
            <img
              :src="
                rewardData.wechatPay
                  ? rewardData.wechatPay
                  : 'static/img/wx_reward.png'
              "
...
export default {
  data() {
    ...
    return {
      rewardData: {
        wechatPay:'static/img/wx_reward.png',
        aliPay:'static/img/alipay_reward.png'
      }, //赞赏二维码
      tableData: [
        {
          //赞赏数据
