...
export default {
  data() {
    ...
    return {
      fixDo: false,
      gotoTop: false, //显示返回顶部图标返回顶部
      going: false, //是否正在执行上滑动作
      browseList: "", //热门文章 浏览量最多
      artCommentList: "", //最新评论
      timer: undefined,  //返回顶部计时器
      isTop: true, //用户是否正在进行上划
      catchMeObj: {
        //个人信息
        git: "https://gitee.com/L_02Reve_61",
        qq: "/static/img/qq.png",
        sina: "https://weibo.com",
        wechat: "/static/img/wx.png",
        csdn: "https://blog.csdn.net/qq_56608020?spm=1000.2115.3001.5343",
