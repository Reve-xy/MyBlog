...
<template>
        <div class="detailBox tcommonBox" >
            ...
            <header>
              ...
              <div v-show="detailObj.tagNames[0]" class="detail-tags">
                所属标签：
                <span v-for="item in detailObj.tagNames">
                <el-tag>{{item}}</el-tag>&nbsp;&nbsp;
              </span>
              </div>
                <div class="ui label"  v-show="detailObj.categoryName">
                ...
                <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">
                    <el-col  :span="12"   class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.wechat_image?detailObj.wechat_image: 'static/img/wx_reward.png'" :onerror="$store.state.errorImg"/>
                            <span>微信扫一扫，向我赞赏</span>
                        </div>
                    </el-col>
                    <el-col :span="12"  class="donate-item">
                        <div class="donate-tip">
                            <img :src="detailObj.alipay_image?detailObj.alipay_image:'static/img/alipay_reward.png'" :onerror="$store.state.errorImg"/>
