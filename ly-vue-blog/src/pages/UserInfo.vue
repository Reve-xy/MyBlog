                    ...
                    <ul class="userInfoBox">
                        <li class="avatarlist">
                            ...
                            <el-upload
                              ...
                              <img   v-if="userInfoObj.avatar" :src="userInfoObj.avatar?userInfoObj.avatar:'static/img/tou.jpg'"  class="avatar">
                        ...
                        <li>
                            ...
                            <template>
                              ...
                              <el-radio class="radio" v-model="userInfoObj.sex" label="2">未知</el-radio>
                            </template>
                        </li>
            ...
            <div v-show="!isEdit" class="tcommonBox">
                ...
                <section>
                    <ul class="userInfoBox">
                        ...
                        <li>
                            <span class="leftTitle">性别</span>
                          <span v-if="userInfoObj.sex==0">男</span>
                          <span v-else-if="userInfoObj.sex==1">女</span>
                          <span v-else-if="userInfoObj.sex==2">未知</span>
                        </li>
                    </ul>
...
import {getToken} from "../utils/auth";
    export default {
        ...
        created() { //生命周期函数
            this.routeChange();
            this.uploadURL = store.state.baseURL+'uploadAvatar'
        }
    }
</script>
